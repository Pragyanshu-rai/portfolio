...
const skills = [
  ...
  // CI/CD
  {name: "Docker", level: 70, category: "ci/cd"},
  {name: "Terraform", level: 70, category: "ci/cd"},
  {name: "GitHub Actions", level: 70, category: "ci/cd"},

  // Others
  {name: "Git", level: 95, category: "others"},
  {name: "Linux/Bash", level: 80, category: "others"},
];

const categories = ["all", "frontend", "backend", "database", "cloud", "ci/cd", "others"];
